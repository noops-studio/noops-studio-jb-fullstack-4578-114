...
export default function EditPostUi({ title, body, postId, onSave }: EditPostUiProps) {
  ...
  const handleConfirmUpdate = async () => {
    ...
    // Build FormData to include updated text fields and new image if any.
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-3xl p-6">
            ...
            <div className="mb-6">
              <label htmlFor="post-title" className="block text-gray-700 text-sm font-medium mb-1">
                Title
              </label>
              <input
                id="post-title"
            ...
            <div className="mb-6">
              <label htmlFor="post-body" className="block text-gray-700 text-sm font-medium mb-1">
                Body
              </label>
